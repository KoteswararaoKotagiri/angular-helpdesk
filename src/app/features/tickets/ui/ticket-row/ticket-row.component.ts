...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatCheckboxModule, MatIconModule, MatProgressBarModule, MatTooltipModule, PriorityChipComponent, QuickActionsMenuComponent, StatusChipComponent],
